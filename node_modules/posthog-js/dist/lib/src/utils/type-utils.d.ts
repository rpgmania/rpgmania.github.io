...
export declare const _isUint8Array: (x: unknown) => x is Uint8Array;
...
export declare const _isEmptyString: (x: unknown) => boolean;
export declare const _isNull: (x: unknown) => x is null;
export declare const _isNullish: (x: unknown) => x is null | undefined;
...
export declare const _isDocument: (x: unknown) => x is Document;
export declare const _isFormData: (x: unknown) => x is FormData;
export declare const _isFile: (x: unknown) => x is File;
