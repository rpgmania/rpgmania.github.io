...
export var defaultConfig = function () {
    ...
    return ({
        ...
        debug: (location && _isString(location === null || location === void 0 ? void 0 : location.search) && location.search.indexOf('__posthog_debug=true') !== -1) || false,
        verbose: false,
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        if (((_a = config.bootstrap) === null || _a === void 0 ? void 0 : _a.distinctID) !== undefined) {
            ...
            this.persistence.set_user_state(((_c = config.bootstrap) === null || _c === void 0 ? void 0 : _c.isIdentifiedID) ? 'identified' : 'anonymous');
            this.register({
